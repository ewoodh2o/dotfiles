...
;; Modified 2013 by Elliott Wood <elliott@two-fish.com>
...
;;   ⌘]   - Shift Right
;;   ⌘[   - Shift Left
;;   M-⌘T - Reset File Cache (for Go to File)
...
(defvar textmate-completing-library 'none
...
(global-set-key (kbd "C-s-T") 'textmate-clear-cache)
